...
void plot_plnorm_vs_tau( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", 
               const char* fit_func_name="line", double min_y=-10000, 
               double max_y=-10000 , int bLog=0,
      const char* szDescX="#tau [ms]",const char* szDescY="Normalisation of power law (N_{ref})", const char* szTitle=NULL,
      double fit_min_x=-100000, double fit_max_x=-100000,
