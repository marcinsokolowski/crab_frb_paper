...
void plot_tau_vs_dm( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", const char* modelfile=NULL,
               const char* fit_func_name="line", double min_y=-10000, 
               double max_y=-10000 , int bLog=0, const char* szDescX="DM [pc cm^{-3}]",
