...
void plot_peakflux_vs_tau( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", 
               const char* fit_func_name=NULL, double min_y=-10000, 
               double max_y=-10000 , int bLog=0,
      const char* szDescX="Tau [ms]",const char* szDescY="Peak flux [Jy]", const char* szTitle=NULL,
      double fit_min_x=-100000, double fit_max_x=-100000,
