...
void SpectralLuminosity_DistrPowerLaw( const char* fname, double TotalTimeInHours=0.50,
                int column=0,
                ...
                int bLog=1, const char* szTitleX="Spectral luminosity [erg/s/Hz]", const char* szTitleY="Probability (P) per hour", 
