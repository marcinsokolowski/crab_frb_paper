...
void FluenceRatePerHourPowerLaw_PAPER_JyS( const char* fname, double TotalTimeInHours=0.998768602,
                int column=0,
                double fit_min_x=1.400, double fit_max_x=100.000, 
                double unixtime=-1,
                int dofit=1, int dDbm2DbmPerHz=1,
                double low=0.090, double up=100.000, int bin_no=100,
