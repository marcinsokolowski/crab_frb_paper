...
if [[ $func_name == "leading_edge" ]]; then
   ...
   root -l "plotslope_err.C(\"slope_vs_dm_leading_edge.txt\",\"poly2\",56.7,56.80,\"leading_edge\")"
else 
   ...
   root -l "plotslope_err.C(\"slope_vs_index_pulse.txt\",\"poly2\",56.7,56.80,\"pulse\")"
   root -l "plotrisetime_err.C(\"risetime_vs_index.txt\",\"poly2\",56.7,56.80)"
fi
