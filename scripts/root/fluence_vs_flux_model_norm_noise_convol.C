...
void fluence_vs_flux_model_norm_noise_convol( double F0 = 8000, double noise_multiplier=1.00 ) // fluence is constant in Jy*ms as in Figure 7 in the paper at rate 1-GP/hour :
{
...
/* for norm=1 :  
   ...
   // norm!=1 :
   // see page 2 in /home/msok/Desktop/EDA2/papers/2024/EDA2_FRBs/20250401_modelling_number_of_GPs_CONVOLUTION.odt   // 

/* MY INTEGRAL :
   par[0] = 0.00; // we do not need offset 96.68276102:;
   par[1] = 0.00; // original fit here 4230.48551368 but we need pulse to beat time = 0 
   par[2] = 1298942.29943593;
   par[3] = 0.00059765;
   par[4] = 0.00189938; */

   // ROOT INTEGRAL :
   par[0] = 0.00; // 104.27116132
   par[1] = 0.00; // 4230.48552421
   par[2] = 1303944.53325031;
   par[3] = 0.00059759;
   par[4] = 0.00188474;
