...
void plotsefd_vs_time( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", 
               const char* fit_func_name="hor", double min_y=5000, 
               double max_y=10000, int bLog=0,
      const char* szDescX="Time [sec]",const char* szDescY="SEFD [Jy]", const char* szTitle=NULL,
      double fit_min_x=-100000, double fit_max_x=-100000,
