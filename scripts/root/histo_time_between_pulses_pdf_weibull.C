...
void histo_time_between_pulses_pdf_weibull( const char* fname, 
                int column=0,
...
//      par[0] = 0.001; //100.00
      ...
      // initialise with parameters making an exponential distribution see :
      // https://en.wikipedia.org/wiki/Weibull_distribution
      // vs.
      // https://en.wikipedia.org/wiki/Exponential_distribution
      par[0] = 1/0.07561; // 0.01 - calculated
      par[1] = 1.00;
