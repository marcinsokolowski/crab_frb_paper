...
void plot_psr_profile_TEST_PAPER( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", int bNormaliseInputData=2, bool bShowOriginalDataWithFit=false,
      ...
      const char* szDescY="Flux density [Jy]", 
