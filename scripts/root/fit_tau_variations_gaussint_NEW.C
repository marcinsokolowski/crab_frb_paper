...
//         line->SetParLimits(1,0.00,1000.00);
      ...
      if( strcmp( fit_func_name, "tau_vs_mjd" )==0 ){
         ...
         line = new TF1("fit_func",tau_vs_mjd,fit_min_x,fit_max_x,5);
         line_draw = new TF1("fit_func2",tau_vs_mjd,minX,maxX,5);
         local_func=1;
...
void fit_tau_variations_gaussint_NEW( const char* basename="taumean_vs_time.test", 
