...
#   mp_fit_results.power_law.plot_pdf( mp_arr, ax=ax1 )
   ...
   # over plot fitted power laws see : page 2 in /home/msok/Desktop/SKA/papers/2024/EDA2_FRBs/20250501_final_selfconsistent_fluence_distributions_PAPER.odt
   # fits are in ROOT because they give proper errors, while I cannot see it in package powerlaw ...
   # MP fit:
   # cd /home/msok/Desktop/SKA/papers/2024/EDA2_FRBs/PAPER/FLUENCE_DISTRIB
   #  FCN=194.957 FROM MINOS     STATUS=SUCCESSFUL     28 CALLS         181 TOTAL
   #                  EDM=6.96319e-11    STRATEGY= 1      ERROR MATRIX ACCURATE 
   # EXT PARAMETER                  PARABOLIC         MINOS ERRORS        
   # NO.   NAME      VALUE            ERROR      NEGATIVE      POSITIVE   
   # 1  p0           6.08241e-06   1.98785e-07  -1.97701e-07   1.99883e-07
   # 2  p1          -3.13137e+00   1.96813e-02  -1.98617e-02   1.95087e-02
   plt.plot( mp_bin_centres[1:], my_power_law(mp_bin_centres[1:], 6.08241e-06 , -3.13137 ), color="red" )
   
   # IP fit:
   # page 3 in /home/msok/Desktop/SKA/papers/2024/EDA2_FRBs/20250501_final_selfconsistent_fluence_distributions_PAPER.odt
   # cd /home/msok/Desktop/SKA/papers/2024/EDA2_FRBs/PAPER/FLUENCE_DISTRIB
   # FCN=16.8837 FROM MINOS     STATUS=SUCCESSFUL     28 CALLS         143 TOTAL
   #                  EDM=1.06736e-08    STRATEGY= 1      ERROR MATRIX ACCURATE 
   # EXT PARAMETER                  PARABOLIC         MINOS ERRORS        
   # NO.   NAME      VALUE            ERROR      NEGATIVE      POSITIVE   
   # 1  p0           3.87086e-07   3.98097e-08  -3.89106e-08   4.06946e-08
