...
void plot_norm_vs_time_error( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", double min_y=0, double max_y=100,
                              const char* szDescY="SNR : fitted power law norm vs. time (Rate at SNR=10)",
                              int x_col=0, int y_col=1, int y_col_err=3,
