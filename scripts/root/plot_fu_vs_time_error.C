...
void plot_fu_vs_time_error( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", double min_y=29.54, double max_y=29.64,
                              const char* szDescY="Pulsar rotation frequency [Hz]",
                              int x_col=0, int y_col=2, int y_col_err=3,
                                        int min_local_time=-1e6, int max_local_time=1e6,
               const char* fit_func_name="line",
               int bLog=0,
