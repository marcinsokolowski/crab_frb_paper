...
void plot_timeplidx_vs_time_error( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", double min_y=-6, double max_y=0,
                              const char* szDescY="Power law index of time distributions",
