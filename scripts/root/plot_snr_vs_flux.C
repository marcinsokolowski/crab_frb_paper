...
void plot_snr_vs_flux( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", 
               const char* fit_func_name="line", double min_y=-10000, 
               double max_y=-10000 , int bLog=0,
      const char* szDescX="Flux density [Jy]",const char* szDescY="SNR", const char* szTitle=NULL,
      double fit_min_x=-100000, double fit_max_x=-100000,
