...
//    pGraph->GetXaxis()->SetLimits(0,1);
   ...
   if( fit_func_name && strlen(fit_func_name) ){
      if( strcmp( fit_func_name, "dm_vs_mjd" )==0 ){
         ...
         line = new TF1("fit_func",dm_vs_mjd,fit_min_x,fit_max_x,3);
         line_draw = new TF1("fit_func2",dm_vs_mjd,minX,maxX,3);
         local_func=1;
...
void fit_dm_variations_gaussint_PAPER_3par( const char* basename="DM_vs_UX.txt", 
