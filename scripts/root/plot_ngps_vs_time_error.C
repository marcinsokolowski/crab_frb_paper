...
void plot_ngps_vs_time_error( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", int min_local_time=-1e6, int max_local_time=1e6,
					const char* fit_func_name=NULL, double min_y=0, 
					double max_y=10000, int bLog=1,
