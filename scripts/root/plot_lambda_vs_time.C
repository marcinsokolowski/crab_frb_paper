...
void plot_lambda_vs_time( const char* basename="sigmaG1_vs_lapSigmaG1_for_root", 
                           const char* basename2=NULL,
                           const char* basename3=NULL,
                           int min_local_time=-1e6, int max_local_time=1e6,
               const char* fit_func_name=NULL, double min_y=0.00, 
               double max_y=1.00, int bLog=0,
      const char* szDescX="Local Time",const char* szDescY="Fitted #lambda (of the exponential distribution)", const char* szTitle=NULL,
      int b_percent=0,
      double fit_min_x=-100000, double fit_max_x=-100000,
