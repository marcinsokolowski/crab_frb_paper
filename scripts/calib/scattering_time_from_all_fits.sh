...
if [[ -s "arfiles.txt" ]]; then
   root -l "plot_scattau_vs_time.C(\"taumean_vs_time.txt\",\"maxsnr_taumean_vs_time.txt\",\"arfiles.txt\")"
else
   root -l "plot_scattau_vs_time.C(\"taumean_vs_time.txt\",\"maxsnr_taumean_vs_time.txt\")"
fi   
